  ...
  <div class="menu-manage-page">
    <div class="left-tree">
      ...
      <el-tree ref="tree" :data="treeData" :props="defaultProps" node-key="id" highlight-current
        @node-click="handleNodeClick" :expand-on-click-node="false" :key="treeKey">
        <span class="custom-tree-node" slot-scope="{ node, data }">
          ...
          <span style="float:right;">
            ...
            <el-button type="text" size="mini" style="color:#f56c6c" @click.stop="deleteMenu(node, data)">删除</el-button>
          </span>
        </span>
      </el-tree>
    </div>
    <div class="right-form">
      <el-form v-if="form" :model="form" label-width="100px" class="edit-form" :rules="rules" ref="formRef">
        ...
        <el-form-item label="自定义图标" prop="customIcon">
          <el-upload class="icon-uploader" action="" :show-file-list="false" :before-upload="beforeIconUpload"
            :on-change="handleIconChange" accept=".jpg,.jpeg,.png" :limit="1">
