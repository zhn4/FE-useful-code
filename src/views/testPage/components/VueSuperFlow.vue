<template>
  <div class="flow-page">
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="12">
            <el-form-item label="dotted">
              <el-switch v-model="linkBaseStyle.dotted" active-color="#13ce66" inactive-color="#ff4949"></el-switch>
            </el-form-item>
          </el-col>
          <el-col :span="12">
    ...
    <div class="btns">
      ...
      <el-button type="primary" @click="onSaveJSON">保存JSON</el-button>
      <el-button type="primary" @click="onLoadJSON">加载JSON</el-button>
    </div>
    ...
    <el-dialog :title="drawerConf.title" :visible.sync="drawerConf.visible" :close-on-click-modal="false" width="500px">
      ...
      >
        <el-form-item label="节点名称" prop="name">
          <el-input v-model="nodeSetting.name" placeholder="请输入节点名称" maxlength="90"></el-input>
        </el-form-item>
        <el-form-item label="节点描述" prop="desc">
          <el-input v-model="nodeSetting.desc" placeholder="请输入节点描述" maxlength="90"></el-input>
        </el-form-item>
      </el-form>
      <el-form
        @keyup.native.enter="settingSubmit"
...
export default {
  ...
  methods: {
    ...
    onExportJSON() {
      const jsonData = this.$refs.superFlow.toJSON()
      console.log(jsonData)
    },
    onSaveJSON() {
      localStorage.setItem('superFlowData', JSON.stringify(this.$refs.superFlow.toJSON()))
      this.$message.success('保存成功')
    },
    onLoadJSON() {
      const jsonStr = localStorage.getItem('superFlowData')
      if (jsonStr) {
        const jsonData = JSON.parse(jsonStr)
        console.log(jsonData)
        this.nodeList = jsonData.nodeList
        this.linkList = jsonData.linkList
